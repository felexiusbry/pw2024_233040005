...
<body>
    ...
    <div class="main clearfix position-relative">
        <div class="main_1 clearfix position-absolute top-0 w-100">
            <section id="header">
                <nav class="navbar navbar-expand-md navbar-light navbar-custom" id="navbar_sticky">
                ...
                <div class="row price_1 mt-4">
                    <div class="col-md-4">
                        <div class="price_1i bg-white p-4 text-center">
                            ...
                            <p class="mb-0 mt-3"><i class="fa fa-lock me-1 col_green"></i> 45-days money-back guarantee</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="price_1i bg-white p-4 text-center">
                            ...
                            <p class="mt-2 fs-6"><span class="text-decoration-line-through text-muted">$236.80</span> <span class="fw-bold">$83.00</span> for the first 2 years</p>
                            <h6 class="text-uppercase mt-3"><a class="button_1 d-block" href="#"> Get The Deal</a></h6>
                            <p class="mb-0 mt-3"><i class="fa fa-lock me-1 col_green"></i> 45-days money-back guarantee</p>
                        </div>
                    </div>
